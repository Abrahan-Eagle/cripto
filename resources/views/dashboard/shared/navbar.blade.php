...
<header class="c-header c-header-light c-header-fixed">
  ...
  <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
    ...
    <button class="c-header-toggler c-class-toggler d-lg-none mfe-auto" type="button" data-target="#sidebar"
      ...
      <svg class="c-sidebar-brand-full" width="300" height="146" alt="UniblockWeb Logo">
        <!-- <use xlink:href="assets/brand/coreui-pro.svg#full"></use>
        <use xlink:href="{{asset('assets/brand/coreui.svg#full')}}"></use> -->
        <text x="30" y="80" fill="#055e94" style="font-size: 25px">UniblockWeb</text>
      </svg></a>
...
-->
    ...
    -->
      ...
      <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button"
          ...
          <div class="c-avatar"><img loading="lazy" class="c-avatar-img" src="/images/user/{{auth()->user() -> profile_pic}}"
              alt="{{auth()->user() -> email}}">
          </div>
        </a>
        <div class="dropdown-menu dropdown-menu-right pt-0">
