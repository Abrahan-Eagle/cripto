    ...
    <div class="col-md-12 col-md-offset-2">
        <div id="ui-view">
            <div>
                <div class="fade-in">
                    <div class="card">
                        <div class="card-header"> Lista de Categorias del project
                            <div class="card-header-actions"><a class="card-header-action"
                                    href=" {{ route('categories-project.create', ['level' => 'project']) }} "><small class="text-muted">CREAR
                                                    ...
                                                    <tr role="row" style="vertical-align:middle;  text-align: center;">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-dark"
                                                                href="{{ route('categories-project.show', ['level' => 'project', 'id' => $category->id]) }}"><svg
                                                            ...
                                                            <a class="btn btn-info"
                                                                href="{{ route('categories-project.edit', ['level' => 'project', 'id' => $category->id]) }}"><svg
                                                                    class="c-icon">
                                                                    <use
                                                                        xlink:href="{{ asset('icons/sprites/free.svg#cil-description') }}">
                                                                    </use>
                                                            ...
                                                            <div class="col-sm-2">
                                                                <form method="POST" action="{{ route('categories-project.destroy', ['level' => 'project', 'id' => $category->id]) }}">
                                                                    @csrf
